...
class EmployeeDetail extends Component {
  ...
  componentWillMount(){
    axios.get("/api/v1/employee/detail/"+this.state._id)
    .then(
      (res) => {    
        var chartsConfig = {
          title: {
          ...
          <div className="Detail-card">
            ...
            <div className="Detail-card-row">
              <div className="Detail-card-col align-center">
                <div className="legends fill-width bg-success">{this.state.last7Days.Present}</div>
              </div>
              <div className="Detail-card-col align-center">
                <div className="legends fill-width bg-warning">{this.state.last7Days.Sick}</div>
              </div>
              <div className="Detail-card-col align-center">
                <div className="legends fill-width bg-info">{this.state.last7Days.Vacation}</div>
              </div>
              <div className="Detail-card-col align-center">
                <div className="legends fill-width bg-danger">{this.state.last7Days.Absent}</div>
              </div>
            </div>
            <div className="Detail-card-separator"/>
