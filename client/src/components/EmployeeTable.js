        ...
        return (
          <tr key={"employeeData"+i}>
            ...
            <td>
              ...
              <Button onClick={() => this.deleteEmployee(i)} class="btn btn-light"><Delete/></Button>
            </td>
          </tr>
        );
      } else {
        ...
        <div className="container">
          <div className="table-controls">
            <Link to="/employee/add">
              <Button className="btn btn-light" style={{fontSize: '32px'}} data-toggle="tooltip"
        data-placement="top" title="ADD NEW EMPLOYEE"><AddPerson/></Button>
            </Link>
